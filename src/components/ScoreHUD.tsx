  ...
  return (
    <div className="relative inline-flex flex-col items-center justify-center">
      <svg width={size} height={size} className="transform -rotate-90">
        <defs>
          <linearGradient id="scoreHudGradient" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="var(--accent-1)" />
            <stop offset="60%" stopColor="var(--accent-2)" />
            <stop offset="100%" stopColor="var(--accent-3)" />
          </linearGradient>
          <filter id="scoreHudGlow" x="-20%" y="-20%" width="140%" height="140%">
        ...
        <circle
          ...
          cy={size / 2}
          r={radius}
          stroke="url(#scoreHudGradient)"
          strokeWidth={strokeWidth}
          strokeDasharray={circumference}
          strokeDashoffset={strokeDashoffset}
          strokeLinecap="round"
          fill="transparent"
          filter="url(#scoreHudGlow)"
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
        <span className="text-2xl font-bold font-sans mono-nums tracking-tight text-[var(--text)] drop-shadow-[0_0_10px_rgba(110,123,255,0.4)]">
          {currentScore}
        </span>
